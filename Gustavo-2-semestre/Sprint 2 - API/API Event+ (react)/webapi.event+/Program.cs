...
//habilita o servico de moderador de conteudo do azure
builder.Services.AddSingleton(provider => new ContentModeratorClient(
    new ApiKeyServiceClientCredentials("5d63d3799983451ba89e4679a1a53444"))
{
    Endpoint = "https://eventcontentmoderator.cognitiveservices.azure.com/"
}
    );
